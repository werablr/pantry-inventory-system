...
INSERT INTO recipe_ingredients VALUES(1,1,1.0,'lb','¾ to 1 lb',false);
INSERT INTO recipe_ingredients VALUES(1,2,2.0,'tbsp','',false);
INSERT INTO recipe_ingredients VALUES(1,3,1.0,'tbsp','',false);
INSERT INTO recipe_ingredients VALUES(1,4,1.0,'tsp','',false);
INSERT INTO recipe_ingredients VALUES(1,5,2.0,'cloves','minced',false);
INSERT INTO recipe_ingredients VALUES(1,6,0.5,'tsp','',false);
INSERT INTO recipe_ingredients VALUES(1,7,0.25,'tsp','',false);
INSERT INTO recipe_ingredients VALUES(3,23,1.0,'tbsp',NULL,false);
INSERT INTO recipe_ingredients VALUES(3,20,8.0,'oz',NULL,false);
INSERT INTO recipe_ingredients VALUES(3,16,2.0,'pieces','fried',false);
INSERT INTO recipe_ingredients VALUES(3,22,8.0,'oz',NULL,false);
INSERT INTO recipe_ingredients VALUES(3,18,1.0,'pieces','peeled and sliced',false);
INSERT INTO recipe_ingredients VALUES(3,21,8.0,'oz',NULL,false);
INSERT INTO recipe_ingredients VALUES(3,17,1.0,'cup','fresh',false);
INSERT INTO recipe_ingredients VALUES(3,15,6.0,'links','cooked',false);
INSERT INTO recipe_ingredients VALUES(3,19,1.0,'pieces','toasted',false);
...
INSERT INTO instructions VALUES(5,1,5,'Slice pork and serve. Drizzle with extra balsamic.',20,NULL);
...
INSERT INTO recipe_feedback VALUES(1,1,'25 may 25',5,5,1,true,NULL,'Cutting into medalions before cooking',NULL,NULL,NULL);
...
INSERT INTO conversation_memory VALUES(1,'2025-05-31','instruction','system','User prefers structured database over text files for recipe management',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(2,'2025-05-31','preference','cooking','User is comfortable with Excel/Numbers and wants to learn SQLite',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(3,'2025-05-31','context','planning','User creates weekly menus and prints them by day and meal with video links',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(4,'2025-05-31','instruction','tagging','Database has complete auto-tagging system built-in. Use auto_tag_suggestions view to see what tags should be applied to recipes.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(5,'2025-05-31','instruction','workflow','When user uploads recipe: 1) Add recipe to database 2) Check auto_tag_suggestions for that recipe_id 3) Apply high-confidence tags automatically',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(6,'2025-05-31','preference','tagging','User wants fully automated tagging - no manual tag assignment required',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(7,'2025-05-31','instruction','views','Use recipe_with_tags view to see recipes with their applied tags. Use auto_tag_suggestions to see what tags should be auto-applied.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(8,'2025-06-02','context','system','CRITICAL: SQLite .db files CAN be uploaded to Claude Desktop via + button. Previous conflicting information was incorrect. User successfully uploaded all_things_food.db file multiple times.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(9,'2025-06-02','context','pantry','Successfully imported complete KitchenPal inventory (306 items) using optimized bulk INSERT. Much faster than individual INSERTs. User has full pantry inventory loaded with proper data transformation.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(10,'2025-06-02','context','ingredients','Created comprehensive ingredient mapping system with master_ingredients table, pantry_mapping_approvals workflow, and manual approval process. User prefers to approve ALL mappings manually - no automatic fuzzy matching.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(11,'2025-06-02','context','workflow','Key insight: User stores recipes long-term but only needs ingredient checking when moving recipes to active queue for cooking. This dramatically reduces maintenance overhead.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(12,'2025-06-02','context','learning','User learned SQLite basics using Excel analogies: Database = Workbook, Tables = Worksheets, Browse Data = seeing rows/columns. Prefers simple explanations without SQL complexity.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(13,'2025-06-02','context','success','Successfully approved first ingredient mapping: Dijon mustard pantry item linked to dijon_mustard master ingredient. User understands the process and can repeat for other ingredients.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(14,'2025-06-02','context','pantry_insight','User insight: Pantry ingredients are mostly stable (same brands, same products). Only quantities change after cooking/shopping. Real variety comes from NEW RECIPES, not pantry changes.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(15,'2025-06-02','context','next_session','For next conversation: 1) Continue approving ingredient mappings, 2) Build recipe queue system, 3) Create new recipe ingredient checker, 4) Develop shopping list generator, 5) Test complete workflow with second recipe.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(16,'2025-06-03','instruction','next_session_priority','CRITICAL FIRST STEP: Run the alternative_names_system artifact to create ingredient_alternative_names table and populate with common variations. Then run complete_approval_workflow to bulk approve current mappings. This creates the auto-approval system.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(17,'2025-06-03','context','system_architecture','Built complete auto-approval architecture: ingredient_alternative_names table stores known variations, auto_approval_candidates view identifies matches, trigger automatically adds manual approvals to cross-reference. Every approval teaches system for future.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(18,'2025-06-03','instruction','workflow_sequence','EXACT SEQUENCE: 1) Run alternative_names_system SQL in DB Browser, 2) Run complete_approval_workflow SQL, 3) Check results with provided queries, 4) Continue to recipe queue system. User has artifacts ready to execute.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(19,'2025-06-03','context','user_understanding','User fully grasps the learning system concept: initial high manual work → system learns patterns → eventual 95%+ auto-approval. User wants automated cross-reference updates when manual approvals are made. System designed accordingly.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(20,'2025-06-03','instruction','immediate_next_step','CRITICAL: User ready to run analyze_remaining_75 query to see what categories remain in the 75 pending items. This will guide creation of final master ingredients batch to reach 70%+ auto-approval rate.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(21,'2025-06-03','context','breakthrough_achieved','MAJOR SUCCESS: Auto-approval system working perfectly. Went from 15.3% to 45.8% auto-approval in single execution. Learning system operational with 30+ master ingredients added. User experienced the learning multiplier effect firsthand.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(22,'2025-06-03','instruction','system_architecture','Current system: ingredient_alternative_names table (no FK constraints), comprehensive master ingredients for common items, auto-approval logic with exact/contains matching, learning trigger for future manual approvals. All components working.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(23,'2025-06-03','context','user_satisfaction','User saw dramatic results and understands the learning system value. Excited about the breakthrough but needs break before final push. Ready to continue with remaining 75 items analysis when returning.',4,NULL,1,true);
...
INSERT INTO conversation_memory VALUES(25,'2025-06-04','context','recipe_import_success','RECIPE IMPORT SYSTEM PROVEN: Successfully imported Turkey Sausage Breakfast recipe with 9 ingredients, full data linking, auto-tagging capability. Text format perfectly compatible with bulk import system.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(26,'2025-06-04','context','recipe_library_ready','User has HUNDREDS of recipes in text format ready for bulk import. Format is clean and structured (see Turkey Sausage example). CSV conversion strategy designed. Ready for Stage 1: Recipe Library bulk import.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(27,'2025-06-04','context','ingredients_foundation_complete','Ingredients automation project is COMPLETE and operational. Learning system proven. 70+ master ingredients cover major categories. System ready to handle recipe ingredients automatically.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(28,'2025-06-04','context','current_status','CURRENT STATUS: Ingredients project done. Single recipe import successful. User ready for bulk recipe import vs. Phase 5 ingredient expansion decision. Recipe Queue Stage 1 architecture validated.',5,NULL,1,true);
...
INSERT INTO conversation_memory VALUES(30,'2025-06-04','context','recipe_format_perfect','Users text recipe format is EXCELLENT for bulk processing. Clear structure, ingredient lists, timing data. Much better than typical CSV exports. Text-to-CSV conversion will be clean and efficient.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(31,'2025-06-04','context','learning_system_mastery','Learning system architecture mastered: ingredient_alternative_names table, auto-approval logic, manual approval triggers, learning multiplier effects. Every approval teaches system for future automation.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(32,'2025-06-05','context','database_integration_success','SQLite MCP integration fully restored and operational. Database accessible across all sessions without file uploads. Method: uvx + mcp-server-sqlite pointing to /Users/brianrogers/sqlite-mcp-project/database/All_Things_Food_database.db. Configuration method documented in VS Code project.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(33,'2025-06-05','instruction','database_expansion_vision','USER VISION: Expand All Things Food database to support ALL life projects - work, personal, home improvement, financial planning, etc. Leverage proven automation patterns (learning systems, approval workflows, auto-tagging) for comprehensive "All Things Brian" project management system.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(34,'2025-06-05','context','current_food_system_status','Ingredients automation: 129 approved, 8 pending (94% automation rate). Recipe system: Single recipe tested successfully, ready for bulk import of hundreds of recipes. Learning system operational with alternative names table and auto-approval triggers.',4,NULL,1,true);
INSERT INTO conversation_memory VALUES(35,'2025-06-05','instruction','integration_method_proven','SQLite + MCP + VS Code project structure is the proven method for persistent database access. No more file uploads needed. This architecture can scale to support multiple databases and project domains using same integration approach.',5,NULL,1,true);
INSERT INTO conversation_memory VALUES(36,'2025-06-05','context','technical_setup_working','MCP server configuration: uvx command with mcp-server-sqlite, database path in sqlite-mcp-project/database/ folder, Claude Desktop config pointing to All_Things_Food_database.db. Full integration operational with 26 tables accessible.',4,NULL,1,true);
...
INSERT INTO person_allergies VALUES(1,true,NULL,'Complete avoidance required',NULL);
...
INSERT INTO kitchen_equipment VALUES(1,'Slow Cooker','appliance',NULL,NULL,NULL,'Good',NULL,'Available for meal prep',true);
INSERT INTO kitchen_equipment VALUES(2,'Air Fryer','appliance',NULL,NULL,NULL,'Good',NULL,'Great for healthy cooking',true);
INSERT INTO kitchen_equipment VALUES(3,'Blender','appliance',NULL,NULL,NULL,'Good',NULL,'For smoothies and sauces',true);
INSERT INTO kitchen_equipment VALUES(4,'Sous Vide','appliance',NULL,NULL,NULL,'Good',NULL,'Precision cooking equipment',true);
INSERT INTO kitchen_equipment VALUES(5,'Work Microwave','appliance',NULL,NULL,NULL,'Good',NULL,'Available at workplace',true);
...
INSERT INTO master_ingredients VALUES(1,'pork_tenderloin','Pork Tenderloin','protein','pork_cuts','Lean, tender cut from pork loin','lb, oz','freezer',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(2,'pork_chops','Pork Chops','protein','pork_cuts','Bone-in or boneless chops','pieces, lb','freezer',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(3,'ground_pork','Ground Pork','protein','pork_ground','Ground pork for sausages, meatballs','lb, oz','freezer',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(4,'black_pepper_ground','Black Pepper (Ground)','spice','ground_spices','Pre-ground black pepper','tsp, tbsp, oz','spices',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(5,'black_peppercorns_whole','Black Peppercorns (Whole)','spice','whole_spices','Whole black peppercorns for grinding','tsp, tbsp, oz','spices',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(6,'white_pepper_ground','White Pepper (Ground)','spice','ground_spices','Milder than black pepper','tsp, tbsp, oz','spices',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(7,'garlic_fresh','Garlic (Fresh)','vegetable','aromatics','Fresh garlic cloves','cloves, bulbs','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(8,'garlic_powder','Garlic Powder','spice','ground_spices','Dehydrated ground garlic','tsp, tbsp, oz','spices',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(9,'garlic_salt','Garlic Salt','seasoning','seasoning_blends','Salt mixed with garlic powder','tsp, tbsp, oz','spices',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(10,'balsamic_vinegar','Balsamic Vinegar','condiment','vinegars','Traditional Italian balsamic vinegar','tbsp, cups, oz','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(11,'red_wine_vinegar','Red Wine Vinegar','condiment','vinegars','Vinegar made from red wine','tbsp, cups, oz','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(12,'white_vinegar','White Vinegar','condiment','vinegars','Distilled white vinegar','tbsp, cups, oz','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(14,'olive_oil','Olive Oil','oil','cooking_oils','Refined olive oil for cooking','tbsp, cups, oz','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(15,'dijon_mustard','Dijon Mustard','condiment','mustards','French-style mustard','tsp, tbsp, oz','fridge',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(16,'yellow_mustard','Yellow Mustard','condiment','mustards','American-style yellow mustard','tsp, tbsp, oz','fridge',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(18,'table_salt','Table Salt','seasoning','basic_seasonings','Table Salt','tsp, tbsp, oz','pantry',NULL,'2025-06-02',true);
INSERT INTO master_ingredients VALUES(19,'lemon_pepper','Lemon Pepper Seasoning','spice','seasoning_blends','Lemon pepper seasoning blend','tsp, tbsp, oz','spices',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(20,'crushed_red_pepper','Crushed Red Pepper','spice','hot_spices','Dried crushed red pepper flakes','tsp, tbsp, oz','spices',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(21,'sesame_oil','Sesame Oil','oil','specialty_oils','Asian sesame oil for flavoring','tsp, tbsp, oz','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(22,'bell_pepper_red','Red Bell Pepper','vegetable','peppers','Fresh red bell peppers','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(23,'bell_pepper_green','Green Bell Pepper','vegetable','peppers','Fresh green bell peppers','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(24,'bell_pepper_yellow','Yellow Bell Pepper','vegetable','peppers','Fresh yellow bell peppers','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(25,'bell_pepper_orange','Orange Bell Pepper','vegetable','peppers','Fresh orange bell peppers','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(26,'kimchi','Kimchi','condiment','fermented','Korean fermented cabbage','cups, oz','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(35,'apples','Apples','fruit','fresh_fruit','Fresh apples','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(36,'avocados','Avocados','fruit','fresh_fruit','Fresh avocados','pieces, cups','other',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(37,'bananas','Bananas','fruit','fresh_fruit','Fresh bananas','pieces, cups','other',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(38,'lemons','Lemons','fruit','citrus','Fresh lemons','pieces, juice','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(39,'limes','Limes','fruit','citrus','Fresh limes','pieces, juice','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(40,'broccoli','Broccoli','vegetable','cruciferous','Fresh broccoli','cups, heads','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(41,'carrots','Carrots','vegetable','root_vegetables','Fresh carrots','pieces, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(42,'celery','Celery','vegetable','stalks','Fresh celery','stalks, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(43,'mushrooms','Mushrooms','vegetable','fungi','Fresh mushrooms','cups, pieces','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(44,'spinach','Spinach','vegetable','leafy_greens','Fresh spinach','cups, oz','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(45,'potatoes','Potatoes','vegetable','root_vegetables','Fresh potatoes','pieces, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(46,'corn','Corn','vegetable','grains','Fresh or frozen corn','cups, ears','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(47,'cabbage','Cabbage','vegetable','cruciferous','Fresh cabbage','heads, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(48,'green_beans','Green Beans','vegetable','legumes','Fresh green beans','cups, lbs','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(49,'white_kidney_beans','White Kidney Beans','protein','legumes','Canned or dried white kidney beans','cups, cans','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(50,'beans','Beans (Generic)','protein','legumes','Generic beans','cups, cans','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(51,'basil','Basil','herb','fresh_herbs','Fresh basil','leaves, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(52,'thai_basil','Thai Basil','herb','fresh_herbs','Fresh Thai basil','leaves, cups','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(53,'cilantro','Cilantro','herb','fresh_herbs','Fresh cilantro','cups, bunches','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(54,'ginger','Ginger','spice','fresh_spices','Fresh ginger root','pieces, tbsp','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(55,'butter','Butter','dairy','fats','Butter','tbsp, sticks','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(56,'eggs','Eggs','protein','poultry','Chicken eggs','pieces, dozen','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(57,'milk','Milk','dairy','liquids','Milk','cups, oz','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(58,'heavy_cream','Heavy Cream','dairy','cream','Heavy whipping cream','cups, oz','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(59,'cream_cheese','Cream Cheese','dairy','cheese','Cream cheese','oz, packages','fridge',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(60,'sugar_white','White Sugar','baking','sweeteners','White granulated sugar','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(61,'sugar_brown','Brown Sugar','baking','sweeteners','Brown sugar','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(62,'flour','All-Purpose Flour','baking','flours','All-purpose flour','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(63,'baking_powder','Baking Powder','baking','leavening','Baking powder','tsp, cans','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(64,'vanilla_extract','Vanilla Extract','baking','extracts','Pure vanilla extract','tsp, bottles','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(65,'rice_brown','Brown Rice','grain','rice','Brown rice','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(66,'rice_jasmine','Jasmine Rice','grain','rice','Jasmine rice','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(67,'rice_wild','Wild Rice','grain','rice','Wild rice blend','cups, lbs','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(68,'bread_white','White Bread','grain','bread','White bread','slices, loaves','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(69,'bread_whole_wheat','Whole Wheat Bread','grain','bread','Whole wheat bread','slices, loaves','pantry',NULL,'2025-06-03',true);
INSERT INTO master_ingredients VALUES(70,'tomatoes_fresh','Tomatoes (Fresh)','vegetable','nightshades','Fresh tomatoes for cooking and salads','pieces, lbs, cups','fridge','Includes cherry tomatoes and regular tomatoes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(71,'tomatoes_canned','Tomatoes (Canned)','vegetable','canned_vegetables','Canned tomato products for cooking','cans, cups, oz','pantry','Includes diced, crushed, sauce, and paste','2025-06-04',true);
INSERT INTO master_ingredients VALUES(72,'cherry_tomatoes','Cherry Tomatoes','vegetable','nightshades','Small fresh tomatoes','cups, pints, pieces','fridge','Specific variety of fresh tomatoes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(73,'onions_yellow','Yellow Onions','vegetable','aromatics','Standard cooking onions','pieces, lbs, cups','pantry','Most common onion variety - includes sweet onions','2025-06-04',true);
INSERT INTO master_ingredients VALUES(74,'onions_red','Red Onions','vegetable','aromatics','Red/purple onions for salads and cooking','pieces, lbs, cups','pantry','Good raw or cooked','2025-06-04',true);
INSERT INTO master_ingredients VALUES(75,'onions_white','White Onions','vegetable','aromatics','White onions for cooking','pieces, lbs, cups','pantry','Milder than yellow onions','2025-06-04',true);
INSERT INTO master_ingredients VALUES(76,'green_onions','Green Onions','vegetable','aromatics','Scallions/spring onions','bunches, pieces, cups','fridge','Also called scallions or spring onions','2025-06-04',true);
INSERT INTO master_ingredients VALUES(77,'cheese_parmesan','Parmesan Cheese','dairy','hard_cheese','Aged Italian hard cheese','cups, oz, pieces','fridge','Grated or block form','2025-06-04',true);
INSERT INTO master_ingredients VALUES(78,'cheese_mozzarella','Mozzarella Cheese','dairy','soft_cheese','Italian cheese for melting','cups, oz, pieces','fridge','Fresh or low-moisture varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(79,'cheese_cheddar','Cheddar Cheese','dairy','hard_cheese','Sharp or mild cheddar cheese','cups, oz, pieces','fridge','Various ages and sharpness levels','2025-06-04',true);
INSERT INTO master_ingredients VALUES(80,'yogurt_greek','Greek Yogurt','dairy','yogurt','Thick strained yogurt','cups, containers, oz','fridge','Plain or flavored varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(81,'chicken_breast','Chicken Breast','protein','poultry','Boneless chicken breast meat','lbs, pieces, oz','freezer','Lean white meat cut','2025-06-04',true);
INSERT INTO master_ingredients VALUES(82,'chicken_thighs','Chicken Thighs','protein','poultry','Chicken thigh meat','lbs, pieces, oz','freezer','Dark meat - bone-in or boneless','2025-06-04',true);
INSERT INTO master_ingredients VALUES(83,'ground_beef','Ground Beef','protein','beef_ground','Ground beef for cooking','lbs, oz','freezer','Various fat percentages available','2025-06-04',true);
INSERT INTO master_ingredients VALUES(84,'ground_turkey','Ground Turkey','protein','poultry_ground','Ground turkey meat','lbs, oz','freezer','Lean alternative to ground beef','2025-06-04',true);
INSERT INTO master_ingredients VALUES(85,'eggplant','Eggplant','vegetable','nightshades','Purple eggplant for cooking','pieces, lbs, cups','fridge','Lilibeth loves, Brian dislikes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(86,'paprika_regular','Paprika','spice','ground_spices','Ground paprika spice','tsp, tbsp, oz','spices','Includes regular and smoked varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(87,'onion_powder','Onion Powder','spice','ground_spices','Dehydrated ground onion','tsp, tbsp, oz','spices','Convenient onion flavoring','2025-06-04',true);
INSERT INTO master_ingredients VALUES(88,'oregano','Oregano','spice','herbs','Dried oregano herb','tsp, tbsp, oz','spices','Mediterranean herb for cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(89,'brussels_sprouts','Brussels Sprouts','vegetable','cruciferous','Small cabbage-like vegetables','cups, lbs, pieces','fridge','Roast or sauté for best flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(90,'asparagus','Asparagus','vegetable','stalks','Fresh asparagus spears','bunches, cups, pieces','fridge','Trim woody ends before cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(91,'bok_choy','Bok Choy','vegetable','leafy_greens','Asian leafy green vegetable','heads, cups','fridge','Use both leaves and stalks','2025-06-04',true);
INSERT INTO master_ingredients VALUES(92,'lettuce','Lettuce','vegetable','leafy_greens','Fresh lettuce for salads','heads, cups, bags','fridge','Various types - romaine, iceberg, etc.','2025-06-04',true);
INSERT INTO master_ingredients VALUES(93,'cauliflower','Cauliflower','vegetable','cruciferous','White cruciferous vegetable','heads, cups, pieces','fridge','Can substitute for rice or potatoes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(94,'zucchini','Zucchini','vegetable','squash','Summer squash vegetable','pieces, cups, lbs','fridge','Very versatile - grill, sauté, or bake','2025-06-04',true);
INSERT INTO master_ingredients VALUES(95,'cucumber','Cucumber','vegetable','fresh_vegetables','Fresh cucumber for salads','pieces, cups','fridge','Great for salads and snacking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(96,'chili_powder','Chili Powder','spice','ground_spices','Ground chili spice blend','tsp, tbsp, oz','spices','Blend of chilies and spices','2025-06-04',true);
INSERT INTO master_ingredients VALUES(97,'cayenne_pepper','Cayenne Pepper','spice','hot_spices','Ground cayenne pepper','tsp, tbsp, oz','spices','Very hot - use sparingly','2025-06-04',true);
INSERT INTO master_ingredients VALUES(98,'turmeric','Turmeric','spice','ground_spices','Ground turmeric root','tsp, tbsp, oz','spices','Golden spice with earthy flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(99,'cinnamon','Cinnamon','spice','sweet_spices','Ground cinnamon bark','tsp, tbsp, oz','spices','Sweet and warm spice','2025-06-04',true);
INSERT INTO master_ingredients VALUES(100,'nutmeg','Nutmeg','spice','sweet_spices','Ground nutmeg seed','tsp, tbsp, oz','spices','Warm, sweet, and slightly nutty','2025-06-04',true);
INSERT INTO master_ingredients VALUES(101,'thyme','Thyme','spice','herbs','Dried thyme leaves','tsp, tbsp, oz','spices','Earthy herb for Mediterranean cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(102,'rosemary','Rosemary','spice','herbs','Dried rosemary leaves','tsp, tbsp, oz','spices','Pine-like flavor, great with potatoes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(103,'cumin','Cumin','spice','ground_spices','Ground cumin seeds','tsp, tbsp, oz','spices','Warm, earthy flavor for Middle Eastern dishes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(104,'bay_leaves','Bay Leaves','spice','whole_herbs','Dried bay leaves','pieces, oz','spices','Remove before serving','2025-06-04',true);
INSERT INTO master_ingredients VALUES(105,'parsley_dried','Parsley (Dried)','spice','herbs','Dried parsley flakes','tsp, tbsp, oz','spices','Mild herb for garnish and flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(106,'bacon','Bacon','protein','pork_cured','Cured pork bacon strips','slices, lbs, packages','fridge','Cook until crispy','2025-06-04',true);
INSERT INTO master_ingredients VALUES(107,'shrimp','Shrimp','protein','seafood','Fresh or frozen shrimp','lbs, pieces, oz','freezer','Various sizes available','2025-06-04',true);
INSERT INTO master_ingredients VALUES(108,'salmon_fillets','Salmon Fillets','protein','seafood','Fresh salmon fish fillets','fillets, lbs, oz','freezer','Rich in omega-3 fatty acids','2025-06-04',true);
INSERT INTO master_ingredients VALUES(109,'italian_sausage','Italian Sausage','protein','pork_sausage','Seasoned Italian pork sausage','links, lbs, packages','freezer','Sweet or hot varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(110,'soy_sauce','Soy Sauce','condiment','asian_sauces','Fermented soy sauce','tbsp, cups, bottles','pantry','Essential for Asian cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(111,'hoisin_sauce','Hoisin Sauce','condiment','asian_sauces','Sweet Chinese sauce','tbsp, cups, jars','fridge','Sweet and savory flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(112,'oyster_sauce','Oyster Sauce','condiment','asian_sauces','Thick savory sauce','tbsp, cups, bottles','fridge','Rich umami flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(113,'honey','Honey','sweetener','natural_sweeteners','Pure honey','tbsp, cups, jars','pantry','Natural sweetener and flavor enhancer','2025-06-04',true);
INSERT INTO master_ingredients VALUES(114,'baking_soda','Baking Soda','baking','leavening','Sodium bicarbonate for baking','tsp, tbsp, boxes','pantry','Leavening agent and cleaning helper','2025-06-04',true);
INSERT INTO master_ingredients VALUES(115,'sesame_seeds','Sesame Seeds','seeds','cooking_seeds','Black or white sesame seeds','tsp, tbsp, cups','pantry','Nutty flavor for Asian dishes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(116,'italian_seasoning','Italian Seasoning','spice','seasoning_blends','Blend of Italian herbs','tsp, tbsp, oz','spices','Oregano, basil, thyme blend','2025-06-04',true);
INSERT INTO master_ingredients VALUES(117,'taco_seasoning','Taco Seasoning Mix','spice','seasoning_blends','Mexican spice blend for tacos','packets, tsp, tbsp','spices','Pre-mixed taco spices','2025-06-04',true);
INSERT INTO master_ingredients VALUES(118,'chinese_five_spice','Chinese Five Spice','spice','seasoning_blends','Traditional Chinese spice blend','tsp, tbsp, oz','spices','Sweet and savory Asian blend','2025-06-04',true);
INSERT INTO master_ingredients VALUES(119,'curry_powder','Curry Powder','spice','seasoning_blends','Indian curry spice blend','tsp, tbsp, oz','spices','Turmeric-based spice mix','2025-06-04',true);
INSERT INTO master_ingredients VALUES(120,'garam_masala','Garam Masala','spice','seasoning_blends','Warm Indian spice blend','tsp, tbsp, oz','spices','Warming spices for Indian dishes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(121,'ketchup','Tomato Ketchup','condiment','tomato_based','Tomato ketchup condiment','tbsp, cups, bottles','pantry','Classic tomato condiment','2025-06-04',true);
INSERT INTO master_ingredients VALUES(122,'hot_sauce','Hot Sauce','condiment','spicy_sauces','Spicy pepper sauce','tsp, tbsp, bottles','fridge','Add heat to any dish','2025-06-04',true);
INSERT INTO master_ingredients VALUES(123,'worcestershire_sauce','Worcestershire Sauce','condiment','fermented_sauces','Fermented savory sauce','tsp, tbsp, bottles','pantry','Complex umami flavor','2025-06-04',true);
INSERT INTO master_ingredients VALUES(124,'vinegar_asian','Asian Vinegar','condiment','vinegars','Asian-style vinegar','tbsp, cups, bottles','pantry','For Asian cooking and dressings','2025-06-04',true);
INSERT INTO master_ingredients VALUES(125,'bouillon_cubes','Bouillon Cubes','pantry','flavor_enhancers','Concentrated broth cubes','cubes, packets','pantry','Instant broth for cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(126,'water_chestnuts','Water Chestnuts','vegetable','canned_vegetables','Canned water chestnuts','cans, cups','pantry','Crunchy texture for stir-fries','2025-06-04',true);
INSERT INTO master_ingredients VALUES(127,'bamboo_shoots','Bamboo Shoots','vegetable','canned_vegetables','Canned bamboo shoots','cans, cups','pantry','Asian vegetable for stir-fries','2025-06-04',true);
INSERT INTO master_ingredients VALUES(128,'vienna_sausage','Vienna Sausage','protein','canned_meat','Canned Vienna sausages','cans, pieces','pantry','Convenient canned protein','2025-06-04',true);
INSERT INTO master_ingredients VALUES(129,'chia_seeds','Chia Seeds','seeds','superfoods','Nutritious chia seeds','tbsp, cups, bags','pantry','High in omega-3 and fiber','2025-06-04',true);
INSERT INTO master_ingredients VALUES(130,'breakfast_cereal','Breakfast Cereal','grain','cereals','Ready-to-eat breakfast cereal','cups, boxes','pantry','Various types and brands','2025-06-04',true);
INSERT INTO master_ingredients VALUES(131,'chocolate_spread','Chocolate Hazelnut Spread','condiment','sweet_spreads','Chocolate and hazelnut spread','tbsp, jars','pantry','Sweet spread for bread and desserts','2025-06-04',true);
INSERT INTO master_ingredients VALUES(132,'pasta_alternative','Alternative Pasta','grain','specialty_pasta','Chickpea, lentil, and other alternative pastas','boxes, cups, oz','pantry','Banza and other protein-rich pastas','2025-06-04',true);
INSERT INTO master_ingredients VALUES(133,'instant_noodles','Instant Noodles','grain','quick_meals','Cup noodles and ramen varieties','cups, packages','pantry','Quick cooking noodle meals','2025-06-04',true);
INSERT INTO master_ingredients VALUES(134,'rice_flavored','Flavored Rice Mixes','grain','rice_varieties','Seasoned and flavored rice blends','boxes, cups','pantry','Pre-seasoned rice products','2025-06-04',true);
INSERT INTO master_ingredients VALUES(135,'rice_specialty','Specialty Rice','grain','rice_varieties','Long grain, wild, and mixed rice varieties','boxes, cups, lbs','pantry','Premium and mixed rice blends','2025-06-04',true);
INSERT INTO master_ingredients VALUES(136,'condensed_milk','Sweetened Condensed Milk','dairy','milk_products','Sweetened condensed milk for baking','cans, cups','pantry','Essential for desserts and baking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(137,'cream_soup_base','Cream Soup Base','pantry','soup_mixes','Cream-based soup mixes and bases','packets, cans','pantry','Mushroom, chicken, and other cream soups','2025-06-04',true);
INSERT INTO master_ingredients VALUES(138,'chocolate_chips','Chocolate Chips','baking','chocolate','Baking chocolate chips and morsels','cups, bags, oz','pantry','Various chocolate types for baking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(139,'dairy_alternatives','Dairy Alternatives','dairy','alternatives','Non-dairy milk and cream alternatives','containers, powder','pantry','Coconut, soy, and other alternatives','2025-06-04',true);
INSERT INTO master_ingredients VALUES(140,'peanut_butter','Peanut Butter','pantry','nut_butters','Peanut butter and nut spreads','jars, tbsp, cups','pantry','Creamy and crunchy varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(141,'cooking_spray','Cooking Spray','oil','specialty_oils','Non-stick cooking sprays','cans, sprays','pantry','Butter, olive oil, and plain varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(142,'specialty_oils','Specialty Cooking Oils','oil','cooking_oils','Flavored and specialty cooking oils','bottles, tbsp, cups','pantry','Infused and specialty varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(143,'coconut_products','Coconut Products','pantry','coconut','Coconut milk powder and coconut items','packages, cups','pantry','Milk powder, flakes, and other coconut products','2025-06-04',true);
INSERT INTO master_ingredients VALUES(144,'seeds_specialty','Specialty Seeds','seeds','cooking_seeds','Coriander, sesame, and other cooking seeds','tbsp, cups, oz','pantry','Whole seeds for cooking and garnish','2025-06-04',true);
INSERT INTO master_ingredients VALUES(145,'nuts_snack','Snack Nuts','snacks','nuts','Flavored and prepared nuts','bags, cups, oz','pantry','Garlic nuts, roasted varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(146,'miso_products','Miso Products','condiment','japanese','Miso soup and miso-based products','packets, paste','pantry','White miso, soup mixes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(147,'filipino_specialty','Filipino Specialty Items','pantry','filipino','Filipino cooking ingredients and foods','packages, cans','pantry','Longanisa, calamansi, and Filipino brands','2025-06-04',true);
INSERT INTO master_ingredients VALUES(148,'asian_soup_mixes','Asian Soup Mixes','pantry','soup_mixes','Asian-style soup bases and mixes','packets, cubes','pantry','Egg flower, guava, and specialty Asian soups','2025-06-04',true);
INSERT INTO master_ingredients VALUES(149,'crackers_specialty','Specialty Crackers','snacks','crackers','Wheat thins and specialty crackers','boxes, pieces','pantry','Low sodium, whole grain varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(150,'breading_mixes','Breading Mixes','pantry','coating_mixes','Coating and breading mixes for frying','packages, cups','pantry','Crispy fry and chicken coating mixes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(151,'yeast','Baking Yeast','baking','leavening','Active dry yeast for bread making','packets, jars','pantry','Active dry and instant yeast varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(152,'sugar_varieties','Sugar Varieties','baking','sweeteners','Dark brown, light brown, and specialty sugars','cups, lbs, bags','pantry','Various sugar types for baking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(153,'canned_fish','Canned Fish','protein','canned_seafood','Tuna varieties and canned seafood','cans, oz','pantry','Herb & garlic, plain, and flavored varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(154,'processed_meats','Processed Meats','protein','processed','Roast beef, deli meats, and processed proteins','packages, slices','fridge','Ready-to-eat meat products','2025-06-04',true);
INSERT INTO master_ingredients VALUES(155,'pasta_chickpea','Chickpea Pasta','grain','specialty_pasta','Banza and other chickpea-based pastas','boxes, cups, oz','pantry','High-protein alternative pasta','2025-06-04',true);
INSERT INTO master_ingredients VALUES(156,'noodles_instant','Instant Noodles','grain','quick_meals','Cup noodles and ramen varieties','cups, packages','pantry','Quick cooking noodle meals','2025-06-04',true);
INSERT INTO master_ingredients VALUES(157,'rice_seasoned','Seasoned Rice Mixes','grain','rice_varieties','Flavored rice blends and mixes','boxes, cups','pantry','Pre-seasoned rice products','2025-06-04',true);
INSERT INTO master_ingredients VALUES(158,'rice_wild_blend','Wild Rice Blends','grain','rice_varieties','Long grain and wild rice mixtures','boxes, cups, lbs','pantry','Premium rice blends','2025-06-04',true);
INSERT INTO master_ingredients VALUES(159,'milk_condensed','Condensed Milk','dairy','milk_products','Sweetened condensed milk for baking','cans, cups','pantry','Essential for desserts','2025-06-04',true);
INSERT INTO master_ingredients VALUES(160,'soup_cream_base','Cream Soup Base','pantry','soup_mixes','Cream-based soup mixes','packets, cans','pantry','Mushroom and other cream soups','2025-06-04',true);
INSERT INTO master_ingredients VALUES(161,'chips_chocolate','Chocolate Chips','baking','chocolate','Baking chocolate varieties','cups, bags, oz','pantry','Multiple chocolate types','2025-06-04',true);
INSERT INTO master_ingredients VALUES(162,'butter_peanut','Peanut Butter','pantry','nut_butters','Peanut butter and nut spreads','jars, tbsp, cups','pantry','Creamy and crunchy varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(163,'spray_cooking','Cooking Spray','oil','specialty_oils','Non-stick cooking sprays','cans, sprays','pantry','Various flavored sprays','2025-06-04',true);
INSERT INTO master_ingredients VALUES(164,'products_coconut','Coconut Products','pantry','coconut','Coconut milk powder and products','packages, cups','pantry','Various coconut items','2025-06-04',true);
INSERT INTO master_ingredients VALUES(165,'seeds_cooking','Cooking Seeds','seeds','specialty_seeds','Coriander, sesame, and specialty seeds','tbsp, cups, oz','pantry','Whole seeds for cooking','2025-06-04',true);
INSERT INTO master_ingredients VALUES(166,'nuts_flavored','Flavored Nuts','snacks','nuts','Seasoned and prepared nuts','bags, cups, oz','pantry','Garlic and other flavored nuts','2025-06-04',true);
INSERT INTO master_ingredients VALUES(167,'miso_soup','Miso Soup Products','condiment','japanese','Miso soup mixes and paste','packets, containers','pantry','White miso and soup varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(168,'filipino_foods','Filipino Specialty Foods','pantry','filipino','Filipino cooking ingredients','packages, cans','pantry','Filipino specialty items','2025-06-04',true);
INSERT INTO master_ingredients VALUES(169,'soup_asian','Asian Soup Mixes','pantry','soup_mixes','Asian-style soup bases','packets, cubes','pantry','Specialty Asian soup mixes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(170,'crackers_whole_grain','Whole Grain Crackers','snacks','crackers','Wheat thins and specialty crackers','boxes, pieces','pantry','Healthy cracker varieties','2025-06-04',true);
INSERT INTO master_ingredients VALUES(171,'mix_breading','Breading Mix','pantry','coating_mixes','Coating mixes for frying','packages, cups','pantry','Crispy fry coating mixes','2025-06-04',true);
INSERT INTO master_ingredients VALUES(172,'yeast_baking','Baking Yeast','baking','leavening','Active dry yeast for bread','packets, jars','pantry','Bread making yeast','2025-06-04',true);
INSERT INTO master_ingredients VALUES(173,'sugar_brown_varieties','Brown Sugar Varieties','baking','sweeteners','Dark and light brown sugars','cups, lbs, bags','pantry','Various brown sugar types','2025-06-04',true);
INSERT INTO master_ingredients VALUES(174,'tuna_flavored','Flavored Tuna','protein','canned_seafood','Seasoned tuna varieties','cans, oz','pantry','Herb & garlic and other flavored tuna','2025-06-04',true);
INSERT INTO master_ingredients VALUES(175,'meat_deli','Deli Meats','protein','processed','Sliced deli and processed meats','packages, slices','fridge','Ready-to-eat meats','2025-06-04',true);
...
INSERT INTO conversation_history VALUES(1,2,'insight','user_learning_style','User learns best with Excel analogies, step-by-step explanations, avoiding SQL complexity. Prefers manual control over automation. Values clean data quality above convenience.',5,'2025-06-02',true);
INSERT INTO conversation_history VALUES(2,2,'decision','ingredient_mapping','User requires manual approval for ALL ingredient mappings. No automatic fuzzy matching. Each pantry item must be explicitly linked to master ingredients with user approval.',5,'2025-06-02',true);
INSERT INTO conversation_history VALUES(3,2,'insight','pantry_reality','Pantry ingredients are mostly stable (same brands, same products). Only quantities change with shopping/cooking. New variety comes from NEW RECIPES, not pantry changes.',4,'2025-06-02',true);
INSERT INTO conversation_history VALUES(4,2,'decision','recipe_queue_strategy','Store recipes long-term without immediate ingredient checking. Only verify ingredients when moving recipes to active cooking queue. This dramatically reduces maintenance work.',5,'2025-06-02',true);
INSERT INTO conversation_history VALUES(5,2,'accomplishment','bulk_import','Successfully imported 306 KitchenPal pantry items using optimized bulk INSERT. Performance lesson: single statement 10x faster than individual INSERTs.',4,'2025-06-02',true);
INSERT INTO conversation_history VALUES(6,2,'accomplishment','first_approval','Successfully approved first ingredient mapping: Dijon mustard pantry item linked to dijon_mustard master ingredient. User understands approval process.',3,'2025-06-02',true);
INSERT INTO conversation_history VALUES(7,2,'context','technical_understanding','User comfortable with DB Browser navigation: Browse Data = Excel view, Execute SQL = run commands. Understands Database = Workbook, Tables = Worksheets analogy.',4,'2025-06-02',true);
INSERT INTO conversation_history VALUES(8,2,'goal','next_priorities','Next session: Build recipe queue system, create new recipe ingredient checker, continue ingredient approvals, develop shopping list generator based on current quantities.',5,'2025-06-02',true);
INSERT INTO conversation_history VALUES(9,3,'insight','auto_approval_lifecycle','Ingredient approval follows diminishing returns: Phase 1 = high manual work building cross-reference, Phase 2 = medium work catching edge cases, Phase 3 = minimal work (95%+ auto-approval) for truly new ingredients only. Shopping patterns are stable so system learns user brands.',5,'2025-06-03',true);
INSERT INTO conversation_history VALUES(10,3,'decision','alternative_names_system','Create ingredient_alternative_names table with master_ingredient_key, alternative_name, auto_approve flag, and match_type (exact/contains/brand_variation). This replaces manual approval for known variations.',5,'2025-06-03',true);
INSERT INTO conversation_history VALUES(11,3,'decision','learning_system','All manual approvals automatically add pantry_ingredient_name to cross-reference as auto-approved alternative name. System learns from every manual approval and prevents future manual work for same variations.',5,'2025-06-03',true);
INSERT INTO conversation_history VALUES(12,3,'context','current_problem','User has ~100+ pending ingredient mappings that need approval. Many are obvious matches like "Dijon Mustard" → "dijon_mustard" but require individual manual approval. Need automated system.',4,'2025-06-03',true);
